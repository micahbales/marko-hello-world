...
$_mod.installed("hello-world$1.0.0", "marko", "4.4.28");
...
$_mod.installed("marko$4.4.28", "warp10", "1.3.5");
...
$_mod.def("/hello-world$1.0.0/hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.4.28 - DO NOT EDIT
"use strict";
...
$_mod.def("/hello-world$1.0.0/client", function(require, exports, module, __filename, __dirname) { var helloComponent = require('/hello-world$1.0.0/hello.marko'/*'./hello'*/);

helloComponent.renderSync({ name: 'Marko' })
  .appendTo(document.body);

});
$_mod.run("/hello-world$1.0.0/client");